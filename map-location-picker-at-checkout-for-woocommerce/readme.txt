...
= 1.11.2 (2026-05-18) =
* [Dev] Updated plugin headers to state tested up to versions.

= 1.11.1 (2026-05-18) =
* [Info] Tested on WP 7.0.
* [Info] Tested on WC 10.8.
...
* [Fix] Addressed notices regarding `_load_textdomain_just_in_time`.
* [Dev] Updated Freemius SDK.
* [Info] Tested on WC 10.0.
...
* [Change] Use `WC()->cart->get_total()` instead of `WC()->cart->total` for cart total when running validations.
* [Dev] Updated Freemius SDK.
